...
// PASS  ./graph.test.js
// addVertex
//   ✓ should add a key in the adjacency (2ms)
// addVertices
//   ✓ should add multiple keys in the adjacency
// addEdge
//   ✓ should add the appropriate edges to the adjacency list (1ms)
// removeEdge
//   ✓ should remove the vertices from the adjacency list
// removeVertex
//   ✓ should remove the vertex as well as any edges
// DFS
//   ✓ return an array of the nodes searched using DFS (1ms)
// BFS
...
// Ran all test suites matching /graph.test.js/i.